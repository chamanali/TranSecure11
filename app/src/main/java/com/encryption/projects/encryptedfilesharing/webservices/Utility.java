...
public class Utility {
    ...
    public static boolean checkConnection(@NonNull String errorString) {
        boolean error = false;
    ...
    public static Pair<String, String> GetErrorMessage(@NonNull String errorString) {
        ...
        if (errorString.contains("Unable to resolve host")) {
            ...
            pair = new Pair<>("No Internet Connection!", "Could not connect to network, Please check your internet connection");
